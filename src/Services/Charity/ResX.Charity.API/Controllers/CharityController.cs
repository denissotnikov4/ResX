...
public class CharityController : ControllerBase
{
    ...
    /// <summary>
    /// Returns paginated list of all active charity requests
    /// </summary>
    [HttpGet("requests")]
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return Ok(new { Items = dtos, TotalCount = total, PageNumber = pageNumber, PageSize = pageSize });
    }

    /// <summary>
    /// Returns a single charity request by its ID. Public endpoint
    /// </summary>
    ...
    /// <summary>
    /// Returns an organization by its ID. Public endpoint
    /// </summary>
    ...
    /// <summary>
    /// Creates a new charity organization for the authenticated user
    /// </summary>
    ...
    /// <summary>
    /// Verifies an organization, allowing it to post charity requests
    /// </summary>
    ...
    /// <summary>
    /// Rejects an organization's verification
    /// </summary>
    ...
    /// <summary>
    /// Creates a charity request for the current user's verified organization
    /// </summary>
    [HttpPost("requests")]
    [Authorize]
    ...
    /// <summary>
    /// Marks a charity request as completed
    /// </summary>
