...
namespace ResX.Charity.IntegrationTests.Fixtures;

public sealed class CharityWebAppFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        builder.ConfigureAppConfiguration((_, config) =>
        {
            ...
            {
                ["ConnectionStrings:CharityDb"] = _postgres.ConnectionString,
    ...
    public async Task InitializeAsync()
    {
        ...
        Environment.SetEnvironmentVariable("ConnectionStrings__CharityDb", _postgres.ConnectionString);
        ...
        _ = CreateClient();
        await _postgres.InitializeRespawnerAsync(["charity"]);
    ...
    {
        Environment.SetEnvironmentVariable("ConnectionStrings__CharityDb", null);
